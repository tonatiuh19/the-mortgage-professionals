...
(1, 1, 'Welcome Email', 'Welcome new clients to the loan process', 'email', 'welcome', 'Welcome to The Mortgage Professionals - Your Loan Application', 'Dear {{client_name}},\n\nWelcome to The Mortgage Professionals! We\'re excited to help you with your loan application.\n\nYour application ID is: {{application_id}}\n\nNext steps:\n1. Complete all required documents\n2. Schedule your initial consultation\n3. We\'ll review your application within 24-48 hours\n\nIf you have any questions, please don\'t hesitate to contact us.\n\nBest regards,\n{{broker_name}}\nThe Mortgage Professionals', '["client_name", "application_id", "broker_name"]', 1, 0, 1, '2026-02-04 15:11:33', '2026-02-04 15:11:33'),
(2, 1, 'Document Reminder SMS', 'Remind clients about pending documents', 'sms', 'reminder', NULL, 'Hi {{client_name}}, this is {{broker_name}} from The Mortgage Professionals. You have {{document_count}} pending documents for your loan application. Please upload them at your earliest convenience. Reply STOP to opt out.', '["client_name", "broker_name", "document_count"]', 1, 0, 1, '2026-02-04 15:11:33', '2026-02-04 15:11:33'),
(3, 1, 'Application Update WhatsApp', 'Update clients on application status via WhatsApp', 'whatsapp', 'update', NULL, 'Hi {{client_name}} 👋\n\nGreat news! Your loan application status has been updated to: *{{status}}*\n\n{{additional_notes}}\n\nNext steps: {{next_steps}}\n\nFeel free to reply with any questions!\n\n- {{broker_name}} at The Mortgage Professionals', '["client_name", "status", "additional_notes", "next_steps", "broker_name"]', 1, 0, 1, '2026-02-04 15:11:33', '2026-02-04 15:11:33'),
(4, 1, 'Loan Approved Email', 'Congratulate clients on loan approval', 'email', 'update', 'Congratulations! Your Loan Has Been Approved', 'Dear {{client_name}},\n\nCongratulations! 🎉\n\nWe\'re thrilled to inform you that your loan application #{{application_id}} has been APPROVED!\n\nLoan Details:\n- Loan Amount: ${{loan_amount}}\n- Interest Rate: {{interest_rate}}%\n- Closing Date: {{closing_date}}\n\nNext Steps:\n1. Review the loan documents we\'ll send shortly\n2. Schedule your closing appointment\n3. Prepare for your new home!\n\nThank you for choosing The Mortgage Professionals. We\'re excited to be part of your homeownership journey!\n\nBest regards,\n{{broker_name}}\nThe Mortgage Professionals', '["client_name", "application_id", "loan_amount", "interest_rate", "closing_date", "broker_name"]', 1, 0, 1, '2026-02-04 15:11:33', '2026-02-04 15:11:33'),
(5, 1, 'Quick Update SMS', 'Send quick status updates via SMS', 'sms', 'update', NULL, 'Hi {{client_name}}! Quick update on your loan app #{{application_id}}: {{status_message}}. Questions? Call us! - {{broker_name}} at The Mortgage Professionals', '["client_name", "application_id", "status_message", "broker_name"]', 1, 0, 1, '2026-02-04 15:11:33', '2026-02-04 15:11:33'),
